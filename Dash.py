...
app.layout = html.Div([
    ...
    style={ 'color': '#503D36', 'textAlign': 'center', 'font-size': 24}),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            ...
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(R_chart4)],style={'display': 'inline-block'})
            ]
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        yearly_as= data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        Y_chart1 = dcc.Graph(figure=px.line( yearly_as, 
                x='Year',
                y='Automobile_Sales',
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(children= Y_chart3),html.Div(children= Y_chart4)],style={'display': 'inline-block'})
                ]
